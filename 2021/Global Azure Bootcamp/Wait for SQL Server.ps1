...
$HeroImage = New-BTImage -Source 'D:\OneDrive\Documents\GitHub\Presentations\2021\Controlling Permissions to Azure SQL Database and Azure SQL Managed Instance using Excel and Azure DevOps\interruptcat.jpg' -HeroImage
