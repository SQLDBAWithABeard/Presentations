...
cd 'Presentations:\Sentryone - Intro To Pester'
...
## Lets look at one with some failures and so that you can see what Environmental Validation looks like with Power bi

Start-Process   'Presentations:\SQL Saturday Gothenburg - Green is Good Red is Bad\Test Ola Report.pbix'
