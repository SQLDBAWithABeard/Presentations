...
Add-AzKeyVaultNetworkRule -VaultName AzureBeard-kv -ResourceGroupName NewBeard-Admin -IpAddressRange (whatsmyip)
#endregion
...
$devadminpwd = (Get-AzKeyVaultSecret -VaultName AzureBeard-kv -Name beardsql-dev-admin-pwd).SecretValue
...
$testadminpwd = (Get-AzKeyVaultSecret -VaultName AzureBeard-kv -Name beardsql-test-admin-pwd).SecretValue
...
$deploymentConfig = @{
    ...
    workspaceResourceGroup     = 'NewBeard-Admin'
    environment                = 'prod'
}
New-AzResourceGroupDeployment @deploymentConfig
...
$prodadminpwd = (Get-AzKeyVaultSecret -VaultName AzureBeard-kv -Name beardsql-prod-admin-pwd).SecretValue
