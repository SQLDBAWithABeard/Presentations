...
# tag the image
docker tag sqldbawithabeard/datagrillen1 sqldbawithabeard/datagrillen1:v0.7.0
...
docker push sqldbawithabeard/datagrillen1:v0.7.0
...
docker tag instance1 sqldbawithabeard/datagrillen1:v0.7.0
docker push sqldbawithabeard/datagrillen1:v0.7.0
