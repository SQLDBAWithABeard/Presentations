...
# tag the image
docker tag sqldbawithabeard/datagrillen1 sqldbawithabeard/datagrillen1:v0.3.0
docker tag sqldbawithabeard/datagrillen2 sqldbawithabeard/datagrillen2:v0.3.0
...
docker push sqldbawithabeard/datagrillen1:v0.3.0
docker push sqldbawithabeard/datagrillen2:v0.3.0
...
docker tag instance1 sqldbawithabeard/datagrillen1:v0.3.0
docker push sqldbawithabeard/datagrillen1:v0.3.0

cd  ..\datagrillen2
docker build -t instance2 . # --progress=plain --no-cache
docker tag instance2 sqldbawithabeard/datagrillen2:v0.3.0
docker push sqldbawithabeard/datagrillen2:v0.3.0
