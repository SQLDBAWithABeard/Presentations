...
Describe "Testing for Presentation" {
    ...
    Context "Setup" {
        ...
        iT "Get-SpeakerBeard.ps1 should not exist"{
            Test-Path 'Presentations:\SQL Saturday Holland - Intro To Pester\Get-SpeakerBeard.ps1' | Should Be $false
        }
        iT "Get-SpeakerBeard.Tests.ps1 should not exist"{
            Test-Path 'Presentations:\SQL Saturday Holland - Intro To Pester\Get-SpeakerBeard.Tests.ps1' | Should Be $false
        }
    }
}