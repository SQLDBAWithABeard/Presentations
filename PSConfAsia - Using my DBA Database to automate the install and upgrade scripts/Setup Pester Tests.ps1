...
# To Load SQL Server Management Objects into PowerShell
  ...
  [System.Reflection.Assembly]::LoadWithPartialName('Microsoft.SqlServer.SMOExtended')  | out-null
    ...
    Context "SQL State" {
        $SQLServers = 'SQL2005Ser2003','SQL2008Ser2008','SQL2012Ser08AG1','SQL2012Ser08AG2','SQL2012Ser08AG3','SQL2014Ser12r2','SQL2016N1','SQL2016N2'
        ...
        $Srv.Databases['master'].StoredProcedures.Name.Contains('sp_WhoIsActive').Count | Should Be 0
        }
