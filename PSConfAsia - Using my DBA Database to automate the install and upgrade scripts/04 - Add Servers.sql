...
EXEC [dbo].[usp_Load_Server] @Server = 'SQL2008Ser2008',@Environment = 'Development',@Location = 'Bolton'
EXEC [dbo].[usp_Load_Server] @Server = 'SQL2012Ser08AG1',@Environment = 'Development',@Location = 'Bolton'
EXEC [dbo].[usp_Load_Server] @Server = 'SQL2012Ser08AG2',@Environment = 'Development',@Location = 'Bolton'
EXEC [dbo].[usp_Load_Server] @Server = 'SQL2012Ser08AG3',@Environment = 'Development',@Location = 'Bolton'
EXEC [dbo].[usp_Load_Server] @Server = 'SQL2016N1', @Environment = 'Development',@Location = 'Bolton'
EXEC [dbo].[usp_Load_Server] @Server = 'SQL2016N2',@Environment = 'Development',@Location = 'Bolton'
