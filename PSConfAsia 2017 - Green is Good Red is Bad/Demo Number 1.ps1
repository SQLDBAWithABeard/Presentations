   ...
   <#
    ...
    Context "Programmes"{
        ...
        It "Should have SSMS 17 RC" {
            $Programmes.Where{$_.displayname -eq 'Microsoft SQL Server Management Studio - 17.3'} | Should Not BeNullOrEmpty
        }
        It "SSMS 17 RC should be version 14.0.17199.0" {
            $Programmes.Where{$_.displayname -eq 'Microsoft SQL Server Management Studio - 17.3'}.DisplayVersion | Should Be 14.0.17199.0
        }
    }
}
